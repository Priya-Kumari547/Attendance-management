...
//           }),
//           axios.get('https://localhost:44380/api/DashboardStats/EmployeeProjectsAssignedToCurrentUserToday', {
//             headers: { Authorization: `Bearer ${token}` },
//           }),
//         ]);

//         console.log('API responses:', responses); // Check responses structure
//         console.log('API data:', responses[0].data.AbsentDaysCount);
//                 setDashboardData({
//           totalAbsentEmployees: responses[0].data.AbsentDaysCount,
//           totalProjectsCount: responses[1].data.Total,
//         });
...
//   console.log('Dashboard data:', dashboardData); // Check dashboardData before returning
//   return (
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const endpoints = [
          ...
          'EmployeeProjectsAssignedToCurrentUserToday',
        ];
        ...
        setDashboardData({ totalAbsentEmployees, totalProjectsCount });
        setIsLoading(false);
      } catch (error) {
        console.error('Error fetching data:', error);
        setIsLoading(false);
